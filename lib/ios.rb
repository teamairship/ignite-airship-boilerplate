...
def add_schemes(project_path)
  ...
  main_scheme.launch_action.build_configuration = "Staging"
  main_scheme.test_action.build_configuration = "Staging"
  main_scheme.analyze_action.build_configuration = "Staging"
  main_scheme.archive_action.build_configuration = "Staging"
  main_scheme.profile_action.build_configuration = "Staging"
